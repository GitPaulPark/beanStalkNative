...
function HomeDrawer({navigation}) {
  return (
    <View style={{marginHorizontal: 10, marginTop: 20}}>
      ...
      <CustomListItemButton navigation={navigation} icon={'menu'} title={'Todo 열기'} navigate={'Todo'}/>
      <CustomListItemButton navigation={navigation} icon={'123'} title={'계산기 열기'} navigate={'Calculator'}/>
